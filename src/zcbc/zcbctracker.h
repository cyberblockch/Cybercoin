...
#ifndef Cybercoin_ZCBCTRACKER_H
#define Cybercoin_ZCBCTRACKER_H
...
public:
    CzCBCTracker(std::string strWalletFile);
    ~CzCBCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzCBCWallet* zCBCWallet = NULL);
