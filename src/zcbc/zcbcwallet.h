...
#ifndef Cybercoin_ZCBCWALLET_H
#define Cybercoin_ZCBCWALLET_H
...
public:
    CzCBCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZCBC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZCBC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
