...
/* Cybercoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Cybercoin"
#define QAPP_ORG_DOMAIN "cybercoin.org"
#define QAPP_APP_NAME_DEFAULT "Cybercoin-Qt"
#define QAPP_APP_NAME_TESTNET "Cybercoin-Qt-testnet"
