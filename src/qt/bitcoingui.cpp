                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Cybercoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Cybercoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cybercoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCBC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cybercoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cybercoin Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Cybercoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cybercoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cybercoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Cybercoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cybercoin Core help message to get a list with possible Cybercoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cybercoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Cybercoin Core"); // default title
