...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Cybercoin Core"),
     ...
     * override -datadir in the cybercoin.conf file in the default data directory
     * (to be consistent with cybercoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
