                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCBCPathCustom = GetArg("-zcbcbackuppath", "");
    ...
    if(!strzCBCPathCustom.empty()) {
        ui->wallet_customzcbcbackuppath->setText(QString::fromStdString(strzCBCPathCustom));
        ui->wallet_customzcbcbackuppath_label->setVisible(true);
        ui->wallet_customzcbcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCBCPathCustom.empty()) && nCustomBackupThreshold > 0) {
