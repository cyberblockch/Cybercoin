...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::CBC);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeCybercoinAmount"))
        SoftSetArg("-anonymizecybercoinamount", settings.value("nAnonymizeCybercoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in cybercoin.cpp during shotdown to also remove the window positions
