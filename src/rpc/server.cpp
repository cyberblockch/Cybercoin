...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cybercoin features */
        {"cybercoin", "listmasternodes", &listmasternodes, true, true, false},
        {"cybercoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cybercoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cybercoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"cybercoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"cybercoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"cybercoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cybercoin", "masternodedebug", &masternodedebug, true, true, false},
        {"cybercoin", "startmasternode", &startmasternode, true, true, false},
        {"cybercoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cybercoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cybercoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cybercoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cybercoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cybercoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cybercoin", "preparebudget", &preparebudget, true, true, false},
        {"cybercoin", "submitbudget", &submitbudget, true, true, false},
        {"cybercoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cybercoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cybercoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cybercoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cybercoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cybercoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cybercoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cybercoin", "checkbudgets", &checkbudgets, true, true, false},
        {"cybercoin", "mnsync", &mnsync, true, true, false},
        {"cybercoin", "spork", &spork, true, true, false},
        {"cybercoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzcbcseed", &getzcbcseed, false, false, true},
        {"zerocoin", "setzcbcseed", &setzcbcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzcbc", &searchdzcbc, false, false, true},
        {"zerocoin", "dzcbcstate", &dzcbcstate, false, false, true},
...
{
    return "> cybercoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:40761/\n";
}
