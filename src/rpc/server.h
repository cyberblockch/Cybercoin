...
/**
 * Cybercoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZcbcSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzcbcseed(const UniValue& params, bool fHelp);
extern UniValue getzcbcseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzcbc(const UniValue& params, bool fHelp);
extern UniValue dzcbcstate(const UniValue& params, bool fHelp);
