...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Cybercoin Core cybercoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cybercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cybercoin transaction") + "\n" +
                               "  cybercoin-tx [options] -create [commands]   " + _("Create hex-encoded cybercoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cybercoin transaction
