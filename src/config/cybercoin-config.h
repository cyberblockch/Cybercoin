/* src/config/cybercoin-config.h.  Generated from cybercoin-config.h.in by configure.  */
/* src/config/cybercoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.cybercoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Cybercoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Cybercoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cybercoin"
