...
from fake_stake.base_test import Cybercoin_FakeStakeTest

class zCBCValidCoinSpendTest(Cybercoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zCBCs..." % DENOM_TO_USE)
