...
This document provides guidelines for internationalization of the Cybercoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cybercoin_en.ts` remains unchanged.
