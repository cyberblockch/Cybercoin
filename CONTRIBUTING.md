Contributing to Cybercoin Core
============================

The Cybercoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/cybercoin-project/cybercoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Cybercoin Core project, and is not to be
confused with overall Cybercoin Network Protocol consensus changes.

Whether a pull request is merged into Cybercoin Core rests with the project merge
...
Patches that change Cybercoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Cybercoin consensus, it must have been
...
The project leader is the release manager for each Cybercoin Core release.
