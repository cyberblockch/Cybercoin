...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/cybercoin-cli.cpp \
           src/cybercoin-tx.cpp \
           src/cybercoin.cpp \
           src/db.cpp \
           ...
           src/qt/cybercoin.cpp \
           src/qt/cybercoinstrings.cpp \
...
RESOURCES += src/qt/cybercoin.qrc src/qt/cybercoin_locale.qrc

TRANSLATIONS += src/qt/locale/cybercoin_bg.ts \
                src/qt/locale/cybercoin_de.ts \
                src/qt/locale/cybercoin_en.ts \
                src/qt/locale/cybercoin_es.ts \
                src/qt/locale/cybercoin_fi.ts \
                src/qt/locale/cybercoin_fr.ts \
                src/qt/locale/cybercoin_it.ts \
                src/qt/locale/cybercoin_ja.ts \
                src/qt/locale/cybercoin_pl.ts \
                src/qt/locale/cybercoin_pt.ts \
                src/qt/locale/cybercoin_ru.ts \
                src/qt/locale/cybercoin_sk.ts \
                src/qt/locale/cybercoin_sv.ts \
                src/qt/locale/cybercoin_vi.ts \
                src/qt/locale/cybercoin_zh_CN.ts \
                src/qt/locale/cybercoin_zh_TW.ts
